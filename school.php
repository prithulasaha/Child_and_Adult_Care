...
<body>
    ...
    <section class="daycare" id="daycare">
        <div class="daycare-list">
            <div class="daycare-row">
                <div class="age">4-6years</div>
                <img src="image/s1.jpg" alt="">
                <h2>Batch: <span>SunShine</span></h2>
                <h3>Time:8:00 am-10:00 am</h3>
                <h4>Admission Fee: 3000TK</h4>
                <a href="sunshine.php" class="btn">Admission</a>
            </div>
            <div class="daycare-row">
                <div class="age">4-6years</div>
                <img src="image/s2.jpg" alt="">
                <h2>Batch: <span>MiniMinds</span></h2>
                <h3>Time:11:00 am-1:00 pm</h3>
                <h4>Admission Fee: 3000TK</h4>
                <a href="miniminds.php" class="btn">Admission</a>
            </div>
            <div class="daycare-row">
                <div class="age">4-6years</div>
                <img src="image/s3.jpg" alt="">
                <h2>Batch: <span>TinyTreasure</span></h2>
                <h3>Time:3:00 am-5:00 pm</h3>
                <h4>Admission Fee: 3000TK</h4>
                <a href="tinytreasure.php" class="btn">Admission</a>
            </div>
        </div>
    </section>
