...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    function test_input($data) {
      ...
      $sql="INSERT INTO c (fname,lname,age,gname,g1fname,g1lname,fphn,femail,g2fname,g2lname,mphn,memail,pname,pphn,ppname,ppphn,sname,tid) values('$fname','$lname','$age','$gname','$g1fname','$g1lname','$fphn','$femail','$g2fname','$g2lname','$mphn','$memail','$pname','$pphn','$ppname','$ppphn','$sname','$tid')"; 
...
<section class="contact" id="contact">
    ...
    <div class="abc">
        ...
        <p>1. Bkash: Use Bkash app and choose the payment method. Enter this number (01521527202) as merchant number and give reference C.</p>
