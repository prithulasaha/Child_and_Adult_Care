...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    function test_input($data) {
      ...
      $sql="INSERT INTO infant (fname,lname,db,gname,ffname,flname,fphn,femail,mfname,mlname,mphn,memail,pname,pphn,ppname,ppphn,sname,tid) values('$fname','$lname','$db','$gname','$ffname','$flname','$fphn','$femail','$mfname','$mlname','$mphn','$memail','$pname','$pphn','$ppname','$ppphn','$sname','$tid')"; 
