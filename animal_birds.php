...
<head>
    ...
    <title>Preschool Online Course</title>
    <link rel="stylesheet" href="color_shape.css">
...
<body>
    ...
    <main class="container">
        <section class="main-video">
            <video src="video/animal.mp4" controls autoplay muted></video>
            <h3 class="title"></h3>
        </section>

        <section class="video-playlist">
            <h3 class="title">Learn Animals Birds Fruits & Flowers</h3>
            <p>02 lessons &nbsp; . &nbsp; 05m 86s</p>
            <div class="videos">

            </div>
        </section>
    </main>
    <iframe src="https://forms.gle/6wfSoQ6N71YVvkKe8" width="1600" height="2939" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>

    <script src="animal_bird.js"></script>
</body>
