...
<body>
    ...
    <main class="container">
        <section class="main-video">
            <video src="video/color.mp4" controls autoplay muted></video>
            <h3 class="title"></h3>
        </section>

        <section class="video-playlist">
            <h3 class="title">Learn Colors & Shapes</h3>
            <p>02 lessons &nbsp; . &nbsp; 05m 88s</p>
            <div class="videos">

            </div>
        </section>
    </main>
    <iframe src="https://forms.gle/g2oYoH3NGddimNTQA" width="1600" height="2939" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>

    <script src="pre tutorial.js"></script>
</body>
