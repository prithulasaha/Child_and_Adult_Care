...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    function test_input($data) {
      ...
      $sql="insert into enroll (sname,pay,tid)values('$sname','$pay','$tid')";
        ...
        <form method="POST" action="">
            ...
            <div class="inputBox">
                <select class="combo"  name="sname">
                    ...
                    <option value="colors">Learn Colors & Shapes</option>
                    <option value="animals">Learn Animals Birds Fruits & Flowers</option>
                    <option value="alphabets">Learn Alphabets</option>
                    <option value="numbers">Learn Numbers</option>
                    <option value="months">Learn Name Of Days Months & Seasons</option>
                    <option value="drawings">Explore Drawings</option>
                 </select>
            </div>
            <div class="inputBox">
