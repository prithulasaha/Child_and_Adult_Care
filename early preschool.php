...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    function test_input($data) {
      ...
      $sql="INSERT INTO early_preschool (fname,lname,db,gname,ffname,flname,fphn,femail,mfname,mlname,mphn,memail,pname,pphn,ppname,ppphn,sname,tid) values('$fname','$lname','$db','$gname','$ffname','$flname','$fphn','$femail','$mfname','$mlname','$mphn','$memail','$pname','$pphn','$ppname','$ppphn','$sname','$tid')"; 
...
<section class="contact" id="contact">
    ...
    <form method="POST" action="">
        <div class="title">
            <h1>Early Preschool Admission Form</h1>
        </div>
        <div class="inputBox">
    ...
    <div class="abc">
        ...
        <p>1. Bkash: Use Bkash app and choose the payment method. Enter this number (01521527202) as merchant number and give reference Early Preschool.</p>
